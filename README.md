...
Check out the <code>no_vr</code> branch for code without any OculusVR dependencies if you're just interested in seeing the renderer at work without having to install the additional SDKs.
